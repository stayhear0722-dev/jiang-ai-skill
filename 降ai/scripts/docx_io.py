#!/usr/bin/env python3
"""DOCX helper utilities for the jiang-ai skill.

Commands:
  read <file>                  Print all paragraphs with numbered labels
  replace <file> <idx>         Replace paragraph <idx> (1-based) from stdin
  write <file>                 Write plain text from stdin to a new .docx
  analyze <file>               Extract template formatting metadata
  formatted_write <file>       Write formatted Markdown to .docx
                               Use --template <file> to reuse document styles
"""
